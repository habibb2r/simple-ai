    ...
    return (
      ...
      <div className="relative z-10 text-center  mx-auto px-4">
        <h1 className="text-4xl md:text-5xl font-extrabold text-gray-900">
          Ready to <span className="text-purple-600">Transform <br />Your Social</span> Media?
        </h1>
        <p className="mt-4 text-gray-500">
         Join businesses automating their content and growing their reach effortlessly. Sign up today <br /> and experience the difference!
        </p>
